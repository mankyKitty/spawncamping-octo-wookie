...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t2931) {
      cljs.core.t2931 = {};
      cljs.core.t2931 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta2932 = c;
      ...
      cljs.core.t2931.cljs$lang$type = !0;
      cljs.core.t2931.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t2931")
      };
      cljs.core.t2931.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t2931")
      };
      var c = cljs.core.t2931.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t2931.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t2931.prototype.cljs$core$Fn$ = !0;
      cljs.core.t2931.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta2932
      };
      cljs.core.t2931.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t2931(this.meta, this.f, b)
      }
    }
    return new cljs.core.t2931(b, a, null)
  }(), b)
};
...
var turnboss = {roster:{}};
turnboss.roster.roster_item_icon = function() {
  return cljs.core.PersistentVector.fromArray(["\ufdd0'i.icon-fire", cljs.core.ObjMap.fromObject(["\ufdd0'height", "\ufdd0'width"], {"\ufdd0'height":"64px", "\ufdd0'width":"64px"})], !0)
};
turnboss.roster.RosterEntry = function(a, b) {
  return dommy.template.node.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'li", cljs.core.ObjMap.fromObject(["\ufdd0'classes"], {"\ufdd0'classes":cljs.core.PersistentVector.fromArray(["roster-item", "media", a], !0)}), cljs.core.PersistentVector.fromArray(["\ufdd0'div.pull-left", turnboss.roster.roster_item_icon.call(null, a, b)], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'div.media-body", cljs.core.PersistentVector.fromArray(["\ufdd0'h4", cljs.core.ObjMap.fromObject(["\ufdd0'classes"], 
  {"\ufdd0'classes":cljs.core.PersistentVector.fromArray(["media-heading", "player-name"], !0)}), b.call(null, "\ufdd0'name")], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'div.role", b.call(null, "\ufdd0'role")], !0)], !0)], !0))
};
turnboss.roster.prepare_roster = function() {
  return cljs.core.empty_QMARK_.call(null, jayq.core.$.call(null, ".empty-roster-item")) ? null : jayq.core.$.call(null, "#roster li").remove()
};
turnboss.roster.add_item = function(a) {
  turnboss.roster.prepare_roster.call(null);
  return jayq.core.fade_in.call(null, jayq.core.append.call(null, jayq.core.$.call(null, "#roster"), a))
};
turnboss.grabbers = {};
turnboss.grabbers.grab_field = function(a) {
  return jayq.core.$.call(null, a).val()
};
turnboss.grabbers.ErrorMsg = function(a) {
  return dommy.template.node.call(null, cljs.core.PersistentVector.fromArray(["\ufdd0'div", cljs.core.ObjMap.fromObject(["\ufdd0'classes"], {"\ufdd0'classes":cljs.core.PersistentVector.fromArray(["alert", "alert-block", "alert-error", "fade-in"], !0)}), cljs.core.PersistentVector.fromArray(["\ufdd0'button.close", cljs.core.ObjMap.fromObject(["\ufdd0'type", "\ufdd0'data-dismiss"], {"\ufdd0'type":"button", "\ufdd0'data-dismiss":"alert"}), "x"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'h4.alert-heading", 
  "Oh bother!"], !0), cljs.core.PersistentVector.fromArray(["\ufdd0'p", "" + cljs.core.str(a)], !0)], !0))
};
turnboss.grabbers.display_error = function(a, b) {
  var c = jayq.core.$.call(null, a);
  return cljs.core.empty_QMARK_.call(null, c.html()) ? c.append(dommy.template.node.call(null, turnboss.grabbers.ErrorMsg.call(null, b))) : null
};
turnboss.grabbers.field_empty_QMARK_ = function(a) {
  return cljs.core.empty_QMARK_.call(null, jayq.core.$.call(null, a).val())
};
turnboss.grabbers.grab_player = function() {
  return cljs.core.not.call(null, turnboss.grabbers.field_empty_QMARK_.call(null, "#player-name")) ? cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'role"], {"\ufdd0'name":turnboss.grabbers.grab_field.call(null, "#player-name"), "\ufdd0'role":turnboss.grabbers.grab_field.call(null, "#player-role")}) : null
};
turnboss.grabbers.grab_npc = function() {
  return cljs.core.not.call(null, turnboss.grabbers.field_empty_QMARK_.call(null, "#npc-name")) ? cljs.core.ObjMap.fromObject(["\ufdd0'name", "\ufdd0'role", "\ufdd0'type", "\ufdd0'count"], {"\ufdd0'name":turnboss.grabbers.grab_field.call(null, "#npc-name"), "\ufdd0'role":turnboss.grabbers.grab_field.call(null, "#npc-role"), "\ufdd0'type":turnboss.grabbers.grab_field.call(null, "#npc-type"), "\ufdd0'count":turnboss.grabbers.grab_field.call(null, "#npc-count")}) : turnboss.grabbers.display_error.call(null, 
  ".player-error-box", "NPC Name cannot be empty!")
};
turnboss.core = {};
turnboss.core.clear_form = function(a) {
  cljs.core.find.call(null, turnboss.core.modal.call(null, document.getElementById(a).log(console), "hide"), "input");
  return cljs.core.val.call(null, "")
};
turnboss.core.add_player_btn_clicked = function(a) {
  jayq.core.prevent.call(null, a);
  return cljs.core.not.call(null, turnboss.grabbers.field_empty_QMARK_.call(null, "#player-name")) ? turnboss.roster.add_item.call(null, turnboss.roster.RosterEntry.call(null, "player", turnboss.grabbers.grab_player.call(null))) : turnboss.core.clear_form.call(null, "#new-player-form")
};
turnboss.core.npc_type_is_not_single_QMARK_ = function(a) {
  var b = cljs.core._EQ_.call(null, a, "multiple-npcs");
  return b ? b : cljs.core._EQ_.call(null, a, "mob")
};
turnboss.core.npc_type_selected = function(a) {
  var a = a.currentTarget.id, b = jayq.core.$.call(null, ".npc-count");
  cljs.core.truth_(turnboss.core.npc_type_is_not_single_QMARK_.call(null, a)) && b.show();
  return cljs.core._EQ_.call(null, a, "single-npc") ? b.hide() : null
};
turnboss.core.page_ready_actions = function() {
  jayq.core.$.call(null, "#roster").sortable();
  jayq.core.$.call(null, ".npc-count").hide();
  jayq.core.bind.call(null, jayq.core.$.call(null, "#add-player"), "\ufdd0'click", turnboss.core.add_player_btn_clicked);
  return jayq.core.bind.call(null, jayq.core.$.call(null, ".npc-type"), "\ufdd0'change", turnboss.core.npc_type_selected)
};
jayq.core.document_ready.call(null, turnboss.core.page_ready_actions);
