...
var nodehello = {routes:{}};
nodehello.core = {};
nodehello.core.express = cljs.nodejs.require.call(null, "express");
nodehello.core.app = nodehello.core.express.call(null);
nodehello.core.index_page = function(a, b) {
  return b.send("Hello World!")
};
nodehello.core.routes = cljs.core.PersistentVector.fromArray([cljs.core.ObjMap.fromObject(["\ufdd0'path", "\ufdd0'handler"], {"\ufdd0'path":"/", "\ufdd0'handler":nodehello.core.index_page})], !0);
nodehello.core._start = function() {
  var a = function() {
    var a = nodehello.core.app;
    a.use(nodehello.core.express.logger());
    a.get("/", nodehello.core.index_page);
    a.listen(3E3);
...
cljs.core._STAR_main_cli_fn_STAR_ = nodehello.core._start;
cljs.nodejscli = {};
