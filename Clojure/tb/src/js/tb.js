...
cljs.core._with_meta["function"] = function(a, b) {
  return cljs.core.with_meta.call(null, function() {
    if(void 0 === cljs.core.t2959) {
      cljs.core.t2959 = {};
      cljs.core.t2959 = function(a, b, c) {
        this.meta = a;
        this.f = b;
        this.meta2960 = c;
      ...
      cljs.core.t2959.cljs$lang$type = !0;
      cljs.core.t2959.cljs$lang$ctorPrSeq = function() {
        return cljs.core.list.call(null, "cljs.core/t2959")
      };
      cljs.core.t2959.cljs$lang$ctorPrWriter = function(a, b) {
        return cljs.core._write.call(null, b, "cljs.core/t2959")
      };
      var c = cljs.core.t2959.prototype, d = function(a, b) {
      ...
      c.call = e;
      cljs.core.t2959.prototype.apply = function(a, b) {
        a = this;
        return a.call.apply(a, [a].concat(b.slice()))
      };
      cljs.core.t2959.prototype.cljs$core$Fn$ = !0;
      cljs.core.t2959.prototype.cljs$core$IMeta$_meta$arity$1 = function() {
        return this.meta2960
      };
      cljs.core.t2959.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = function(a, b) {
        return new cljs.core.t2959(this.meta, this.f, b)
      }
    }
    return new cljs.core.t2959(b, a, null)
  }(), b)
};
...
var tb = {core:{}};
tb.core.express = cljs.nodejs.require.call(null, "express");
tb.core.app = tb.core.express.call(null);
tb.core.build_path = function(a) {
  return cljs.core.apply.call(null, cljs.core.str, __dirname, a)
};
tb.core.index_page = function(a, b) {
  return b.render("index", {title:"Turn Boss"})
};
tb.core._start = function() {
  var a = function() {
    var a = tb.core.app;
    a.use(tb.core.express.logger());
    a.set("view engine", "jade");
    a.set("views", tb.core.build_path.call(null, "/public/views"));
    a.get("/", tb.core.index_page);
    a.listen(3E3);
    return cljs.core.println.call(null, "" + cljs.core.str("Server Started on Port: 3000"))
  }, b = function(b) {
    var d = null;
    goog.isDef(b) && (d = cljs.core.array_seq(Array.prototype.slice.call(arguments, 0), 0));
    return a.call(this, d)
...
cljs.core._STAR_main_cli_fn_STAR_ = tb.core._start;
cljs.nodejscli = {};
